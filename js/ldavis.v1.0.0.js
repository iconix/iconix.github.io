...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var globalwidth = window.innerWidth; // 1210
    var globalheight = window.innerHeight; // 780

    // Set global margins used for everything
    var margin = {
        top: globalheight / 26, // 30
        right: globalwidth / 40.3, // 30
        bottom: globalheight / 11.1, // 70
        left: globalwidth / 40.3 // 30
    },
        mdswidth = globalwidth / 2.3, // 530
        mdsheight = globalheight / 1.5, // 530
        barwidth = globalwidth / 2.3, // 530
        barheight = globalheight / 1.5, // 530
        termwidth = globalwidth / 13.5, // 90 // width to add between two panels to display terms
    ...
    function visualize(data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            inputDiv.setAttribute("style", "width: " + globalwidth + "px"); // to match the width of the main svg element
